      ...
      <form className="d-flex flex-column">
        ...
        <label htmlFor="shortName">
          ...
          <input
            ...
            onChange={(e) =>
              this.props.handleUserInput({ shortName: e.target.value })
            }
            required
          />
        </label>
        <label htmlFor="longName">
          ...
          <input
            ...
            onChange={(e) =>
              this.props.handleUserInput({ longName: e.target.value })
            }
            required
          />
        </label>
        <label htmlFor="url">
          ...
          <input
            ...
            onChange={(e) =>
              this.props.handleUserInput({ url: e.target.value })
            }
            required
          />
        </label>
        <label htmlFor="profile">
          ...
          <textarea
            ...
            onChange={(e) =>
              this.props.handleUserInput({ profile: e.target.value })
            }
            required
          />
        </label>
